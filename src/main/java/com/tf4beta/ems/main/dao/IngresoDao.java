...
public class IngresoDao {
    ...
    public Ingreso findById(int id_ingreso_cab){
        String sql = "SELECT i.*, b.nombre,b.codigoB FROM ingreso i LEFT JOIN bodega b ON i.codigo_bodega = b.codigo_bodega WHERE id_ingreso_cab = ?";
    ...
    public  Ingreso findByIdAllDetails(Integer id_ingresocab){
        String sql = "SELECT i.*,b.nombre, b.codigoB, b.ubicacion FROM ingreso i LEFT JOIN bodega b ON i.codigo_bodega = b.codigo_bodega WHERE id_ingreso_cab = ?";
return jdbcTemplate.queryForObject(sql, new IngresoRowMapper(),id_ingresocab);
    ...
    public void delate(Integer id_ingresocab){
        String sql = "DELETE FROM ingreso WHERE id_ingresos_cab = '"+ id_ingresocab + "'";
